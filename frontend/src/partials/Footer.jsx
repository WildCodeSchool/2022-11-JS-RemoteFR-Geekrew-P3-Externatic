...
function Footer() {
  return (
    <footer className="grid grid-cols-3 bg-main-dark fixed bottom-0 text-white">
      <div className="p-4">
        <h2 className="mb-2">Externatic</h2>
        <p className="text-sm">
      ...
      <div className="p-4">
        <h2 className="mb-2">Réseaux</h2>
        <a href="https://www.linkedin.com/company/externatic/">
          <img
            src={linkedin}
            alt="linkedin"
            className="bg-blue inline-block align-middle"
          />
        </a>
      </div>
